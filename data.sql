...
SELECT SUBSTRING (SHA256(RAND()),1,6) AS salt
SELECT SHA256(CONCAT(salt, 'password123')) AS hash_value

INSERT INTO authors (username, password, role) VALUES ('admin', hash_value, 'admin');
--password is 'password123'
INSERT INTO authors (username, password) VALUES ('student', hash_value);
